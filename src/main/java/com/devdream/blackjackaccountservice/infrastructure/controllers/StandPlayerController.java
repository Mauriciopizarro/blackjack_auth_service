...
public class StandPlayerController {
    ...
    public Object standPlayer(@PathVariable String gameId) throws IOException {
        try {
            ...
            String url = "http://blackjack-app-java:8080/api/v1/game/stand/" + gameId + "/" + user.id;
